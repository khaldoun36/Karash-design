<template>
    <form @submit.prevent="submitForm" class="mt-20 grid grid-cols-1 gap-8">
        <input
            ...
            name="name"
            v-model="name"
            class="border-b border-black/15 bg-transparent p-4 text-base text-secondary-800 focus:rounded-md focus:outline-none focus:outline-primary-200/40 lg:text-lg"
        ...
        <textarea
            name="message"
            v-model="message"
            class="border-b border-black/15 bg-transparent px-4 pt-4 text-base text-secondary-800 focus:rounded-md focus:outline-none focus:outline-primary-200/40 lg:text-lg"
